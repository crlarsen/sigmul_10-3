...
//
// Create Date: 05/23/2023 12:25:44 PM
// Design Name:
// Module Name: padder17
// Project Name:
// Target Devices:
// Tool Versions:
// Description: 17-bit Integer Prefix Adder with Carry In/Carry Out
//
...
module padder17(A, B, Cin, S, Cout);
  localparam N = 17;
  input [N-1:0] A, B;
  input Cin;
  output [N-1:0] S;
  ...
  assign Cout = (\G15:-1 & A[16]) | (\G15:-1 & B[16]) | (A[16] & B[16]);
